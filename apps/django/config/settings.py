...
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgres://mugs:mugs@localhost:5432/mugs')
...
# S3 / MinIO storage. Defaults below are for local development only;
# override all of these in production.
